...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    ...
    try {
      ...
      if (!google) { setError('Google SDK failed to load. Please refresh.'); setGLoading(false); return }
    ...
    } catch { setError('Google sign-in unavailable'); setGLoading(false) }
  }
    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <div style={s.card}>
          ...
          <p style={s.subtitle}>Sign in to manage your freelance business</p>

          {error && <div style={s.error}><span style={{ fontWeight: 700 }}>✕</span> {error}</div>}

          {/* Google Sign-In */}
          <button onClick={handleGoogleLogin} disabled={gLoading} style={s.googleBtn}>
            ...
            <div style={s.field}>
              ...
              <div style={s.pwWrap}>
                <input
                  ...
                  placeholder="••••••••" required style={{ ...s.input, paddingRight: '2.5rem' }}
                />
